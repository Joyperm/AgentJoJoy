...
เพื่อป้องกันการรันคำสั่งแบบลองผิดลองถูก (trial-and-error) และรักษาสมดุลเนื้อหาในหน้าต่างบริบท (Context Window) AI ต้องตรวจสอบเมนูช่วยเหลือของเครื่องมือ (`--help`, `-h`, `man`) หรืออ่านเอกสารคู่มือท้องถิ่นก่อนรันเครื่องมือใหม่ เครื่องมือที่ไม่คุ้นเคย หรือเครื่องมือที่เพิ่งติดตั้งใน Workspace เป็นครั้งแรกเสมอ โดยจำกัดเป็นภารกิจสแกนแบบครั้งเดียวต่อเครื่องมือ/เซสชัน และจะเพิ่มประสิทธิภาพของ Subagent ตามประเภทการทำงาน:
- **Executor Subagents** (เน้นสั่งงานอย่างเดียว) จะได้รับเฉพาะคำสั่งเป้าหมายและข้อมูลแวดล้อมที่จำเป็นน้อยที่สุด
- **Cognitive Subagents** (เน้นเขียนสคริปต์/แก้บั๊ก) จะได้รับการโหลดคู่มือช่วยเหลือของเครื่องมือนั้น ๆ เข้าสู่บริบทโดยตรง
...
และสอนได้ 1 แนวคิดต่อก้อน ในโหมด **teach** จะมี **กล่องสอน** สั้น ๆ ในแชตทุก milestone
(อธิบายว่าทำไมโค้ดถึงทำงาน และจุดไหนที่อาจพัง) ด้วยภาษาที่คุณคุย ทำให้ค่อย ๆ เข้าใจ
โดยไม่เสียความเร็ว ส่วนในโหมด **execute** กล่องสอนปิดเป็นค่าเริ่มต้น (เปิด Teaching
toggle ใน `engagement-mode.md` ได้) คุณเปิด **milestone auto-commit** ได้ (ค่าเริ่มต้นปิด ตั้งใน
